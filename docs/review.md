...
Reviewed initial implementation against docs/spec.md and CONTRIBUTING.md. The fixed starting point is 3d0c01e (initial contract). Reviews were performed independently along Standards and Spec axes.
